...
public class CyberSecurityCourseworkDegreeRequirements extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cyber_security_coursework_degree_requirements);

        setTitle("Cybersecurity Track");
        centerTitle();

        infoButton = (Button)findViewById(R.id.cybersecurityTrackInfoButton);

        infoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent intent = new Intent(CyberSecurityCourseworkDegreeRequirements.this,InfoPopUpWindowActivity.class);
                intent.putExtra("activity","cybersecurityTrack");
                startActivity(intent);
            }
        });

        expandableListViewExample = (ExpandableListView) findViewById(R.id.cybersecurityList);
        expandableDetailList = ExpandableListDataItems.getCyberSecruityReqsData();
