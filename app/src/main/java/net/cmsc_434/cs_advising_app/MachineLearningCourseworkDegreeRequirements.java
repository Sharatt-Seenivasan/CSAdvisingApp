...
public class MachineLearningCourseworkDegreeRequirements extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_learning_coursework_degree_requirements);
